...
<center><div class="container col-md-12 col-md-offset-3">
	<div class="row">
		<div class="col-md-2">
			<ul class="nav nav-pills nav-stacked">
				<li role="presentation" class="active"><a href="#">Menu</a></li>
				<li role="presentation"><a href="<?= base_url().'index.php/Admin/users/'.$IdUser.'/'.$nick?>">Usuarios</a></li>
			</ul>
		</div>
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Menu Administrador</h3>
				</div>
				<div class="panel-body">
				<div class="col-md-6">
				<a href="<?= base_url().'index.php/Forum/crear_subforo/'.$IdUser.'/'.$nick?>" class="btn btn-default">Crear nuevo subforo</a>
				</div>
				<div class="col-md-6">
				<a href="<?= base_url().'index.php/Forum/borrar_subforo/'.$IdUser.'/'.$nick?>" class="btn btn-default">Borrar subforo</a>
				</div>					
				</div>
			</div>
		</div>
