	...
	<div class="row">
		<div class="col-md-2">
			<ul class="nav nav-pills nav-stacked">
				...
				<li role="presentation" class="active"><a href="<?= base_url().'index.php/Admin/users'.'/'.$IdUser.'/'.$nick?>">Volver a Usuarios</a></li>
			</ul>
		</div>
		<div class="col-md-10">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Editar usuario <?= $usuario->Nombre ?></h3>
				</div>
				<div class="panel-body">
					<form class="form-horizontal" role="form" method="post" 
						action ="<?= base_url().'index.php/Admin/banear_usuario/'.$usuario->Nick.'/'.$IdUser.'/'.$nick?>">	
						<div class="form-group">	
							<label for="user_rights">Selecciona permisos</label>	
							<select class="form-control" name="user_rights" id="user_rights">
								<?= $options ?>
							</select>
						</div>
						<input type="submit" class="btn btn-default" value="Actualizar permisos">
					</form>
				</div>
			</div>
		</div>
