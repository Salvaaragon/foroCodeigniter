...
<body>
	...
	<?php
		...
		if($query->num_rows() > 0)
		{
			...
			{
				echo '<tr><td class="col-sm-2"><a href="'.base_url().'index.php/foro/postlogueado/'.$row->Id.'/'.$IdUser.'/'.$nick.'">'.$row->Nombre.'</a></td>';
    ...
    <div class="col-md-offset-10">
    	<button type="button" class="btn btn-primary"><a href="<?=base_url()?>index.php/controladorPost/crearPost/<?=$idsubforo?>/<?=$IdUser?>/<?=$nick?>">Crear post</a></button></div>
    </div><!-- /.container -->
