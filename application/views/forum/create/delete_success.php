	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<center><h1>Subforo eliminado con exito</h1>
			</div>
			<center><p>El subforo ha sido eliminado correctamente.<a href="<?=base_url()?>index.php/Admin/admin/<?=$IdUser?>/<?=$nick?>">Volver a menú</a></p>
		</div>
	</div><!-- .row -->
</div><!-- .container -->
