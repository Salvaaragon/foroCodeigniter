	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1>Borrar subforo</h1>
			</div>
		</div>
			<div class="col-md-12">
				<form class="form-horizontal" role="form" method="post" 
						action ="<?=base_url().'index.php/Forum/borrar_subforo/'.$IdUser.'/'.$nick?>">
					<div class="form-group">	
							<label for="subforo">Selecciona subforo</label>	
							<select class="form-control" name="subforo" id="subforo">
								<?= $foros ?>
							</select>
					</div>
					<div class="form-group">
						<input type="submit" class="btn btn-default" value="Borrar subforo">
					</div>
				</form>
			</div>
	</div><!-- .row -->
